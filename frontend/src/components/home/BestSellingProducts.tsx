...
export default function BestSellingProducts() {
  ...
  if (loading) {
    return (
      <section className="bg-[#f6f7f4] py-16 md:py-24">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-3 px-3 min-[420px]:grid-cols-2 md:grid-cols-3 md:gap-5 md:px-6 xl:grid-cols-4">
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
  ...
  return (
    <>
      <section className="bg-[#f6f7f4] py-14 md:py-20">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-10 text-center sm:grid-cols-3 lg:grid-cols-5">
            {[
              ...
              <div key={label} className="relative flex flex-col items-center">
                ...
                <p className="mt-6 text-[11px] tracking-[0.28em] uppercase text-[#5f6568]">
                  {label}
                </p>
                <span className="mt-4 h-[1px] w-6 bg-[#202326]/10" />
                {index !== 4 && (
                  <span className="absolute right-[-22px] top-1/2 hidden h-12 w-px bg-[#202326]/10 lg:block" />
                )}
              </div>
            ))}
          </div>
      ...
      <section className="bg-[radial-gradient(circle_at_20%_10%,#f6f7f4_0%,#eceeed_45%,#e7eeeb_100%)] py-14 md:py-22">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
